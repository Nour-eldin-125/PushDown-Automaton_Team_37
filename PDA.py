...
def main():
    ...
    true=True
    while (true):
        validFiles = ['n0n1','0n1n','wcwr','wcwR']
        automataFilePath = input('Enter the automata file path: ')
        while (automataFilePath not in validFiles):
            automataFilePath =input('please re-enter the automata file name again: ')
        ...
        t = input('would you like to open another file ? Y/N \n')
        if (t=='N' or t=='n'):
            true=False
